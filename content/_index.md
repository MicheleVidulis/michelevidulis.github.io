---
title: Michele Vidulis
---
{{< numbering h2=false h3=false >}}

{{< profile src="images/profile.png" >}}

I am a PhD student at the [Geometric Computing Laboratory](https://gcm.epfl.ch/), [EPFL](https://www.epfl.ch/en/), advised by Prof. [Mark Pauly](https://scholar.google.com/citations?user=bY63wY8AAAAJ&hl=en&oi=ao).

I am interested in physics-based simulation, optimization, computational design, and digital fabrication.

During my PhD, I was fortunate to work with Prof. [Julian Panetta](https://julianpanetta.com/) (UC Davis) and Prof. [Eitan Grinspun](https://www.dgp.toronto.edu/~eitan/) (University of Toronto). I interned at [Disney Research | Studios](https://studios.disneyresearch.com/) in the Rendering and Simulation group with [Vinicius Da Costa De Azevedo](https://studios.disneyresearch.com/people/vinicius-da-costa-de-azevedo/) and [Jingwei Tang](https://studios.disneyresearch.com/people/jingwei-tang/).

I hold a double MSc in Computational Science and Engineering from EPFL and [Politecnico di Milano](https://www.polimi.it/en/). I received my BSc in Mathematical Engineering at Politecnico di Milano.
...
{{< publication/single title="CNets: An Interactive Design Framework for Cone-Nets" >}}
{{< publication/single title="C-Tubes: Design and Optimization of Tubular Structures Composed of Developable Strips" >}}
{{< publication/single title="Tencers: Tension-Constrained Elastic Rods" >}}
{{< publication/single title="Computational Exploration of Multistable Elastic Knots" >}}
